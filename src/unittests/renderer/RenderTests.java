...
public class RenderTests {
    ...
    /**
     * Test for material ambient reflection - Part B of stage 6
     * Based on renderMultiColorTest but using materials instead of emission colors
     */
    @Test
    public void renderMaterialAmbientTest() {
        Scene scene = new Scene("Material Ambient Test").setAmbientLight(new AmbientLight(new Color(java.awt.Color.WHITE)));

        scene.geometries //
                .add(// center - sphere with gray ambient reflection
                        new Sphere(new Point(0, 0, -100), 50)
                                .setMaterial(new Material().setKA(0.4)),
                        // up left - triangle with green ambient reflection
                        new Triangle(new Point(-100, 0, -100), new Point(0, 100, -100), new Point(-100, 100, -100))
                                .setMaterial(new Material().setKA(new Double3(0, 0.8, 0))),
                        // down left - triangle with red ambient reflection
                        new Triangle(new Point(-100, 0, -100), new Point(0, -100, -100), new Point(-100, -100, -100))
                                .setMaterial(new Material().setKA(new Double3(0.8, 0, 0))),
                        // down right - triangle with blue ambient reflection
                        new Triangle(new Point(100, 0, -100), new Point(0, -100, -100), new Point(100, -100, -100))
        ...
        camera //
                ...
                .build() //
                .renderImage() //
                .printGrid(100, new Color(java.awt.Color.WHITE)) //
